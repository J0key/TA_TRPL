...
@section('main')
    <main class="w-[1139px] ml-[322px] min-h-screen flex flex-col">
        ...
        <button
            class="bg-slate-900 px-4 py-2 w-fit h-fit mt-12 rounded-lg text-white text-lg justify-self-end justify-end self-end">
            <div class="flex flex-row">
                <img class="me-4" src="{{ asset('icon/Property 1=icon, Property 2=berkas.png') }}" alt="">
                Upload Via File
        </button>
        </div>

        <div class="w-full h-fit flex flex-row mt-10 space-x-8 bg-white rounded-lg shadow-md shadow-slate-500 px-16">
